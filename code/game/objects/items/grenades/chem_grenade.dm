...
/obj/item/grenade/chem_grenade/cleaner/Initialize()
	. = ..()
	var/obj/item/reagent_containers/glass/beaker/plastic/small/B1 = new(src)// toolbeltstation CHANGE: /glass/beaker --> /glass/beaker/plastic/small to avoid fermichem pH issues
	var/obj/item/reagent_containers/glass/beaker/B2 = new(src)
...
/obj/item/grenade/chem_grenade/ez_clean/Initialize()
	. = ..()
	var/obj/item/reagent_containers/glass/beaker/plastic/B1 = new(src) // toolbeltstation CHANGE: /glass/beaker/large --> /glass/beaker/plastic to avoid fermichem pH issues
