...
/datum/supply_pack/science/beakers
	...
	desc = "Glassware for any chemistry lab! Contains four small beakers, three large, three plastic, two X-large, and one metamaterial. As well as three droppers and two pairs of latex gloves." // toolbeltstation change: "two plastic" --> "three plastic, two X-large"
	cost = 2000
	contains = list(/obj/item/reagent_containers/glass/beaker,
					...
					/obj/item/reagent_containers/glass/beaker/large,
					/obj/item/reagent_containers/glass/beaker/large,
					/obj/item/reagent_containers/glass/beaker/plastic/small, // toolbeltstation change
					/obj/item/reagent_containers/glass/beaker/plastic/small, // toolbeltstation change
					/obj/item/reagent_containers/glass/beaker/plastic/small, // toolbeltstation change
